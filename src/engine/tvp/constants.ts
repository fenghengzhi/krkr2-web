// Numeric TVP API constants from kirikiroid2-web cpp/core/base/ScriptMgnIntf.cpp.
// W.Dee and contributors; original notices are retained in third_party/tjs2/LICENSE.
export const tvpConstants = String.raw`const
/* constants */
