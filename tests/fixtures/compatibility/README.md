...
`tjs-abi4.tar.gz` 来自 [完整回归 34815634377](https://github.com/fenghengzhi/krkr2-web/actions/runs/34815634377) 的 `test-build/dist`，对应 build `8589ed1bdff38cd018b0f1d98f3b5149e248625205013d0cfb199946db458d9c`。文件树由原生调用栈阶段报告固定，供 ABI 5 的原生 Scripts/编译离线升级检查使用。
