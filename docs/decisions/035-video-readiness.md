...
修复后的 [34839360763](https://github.com/fenghengzhi/krkr2-web/actions/runs/34839360763) 使用实际应用实现、关闭测试中的首次 seek 门控，40 次原遮盖案例全部通过；[34839364493](https://github.com/fenghengzhi/krkr2-web/actions/runs/34839364493) 的两个隐藏图层案例也通过。这些专项使用构建 34839287423，后续只修改测试和文档的构建须继续核对应用来源与发布文件；本页保留独立专项与完整回归的区别。
